                ...
                <div className='city-cat-container'>
                    <Link to='/la'>
                        <div className='city-cat la-cat'>
                            ...
                            <div className='condition-container'>
                                <img src={`https://openweathermap.org/img/w/${this.props.la.icon}.png`} alt={this.props.la.condition}/>
                    ...
                    <Link to='/seattle'>
                        <div className='city-cat seattle-cat'>
                            ...
                            <div className='condition-container'>
                                <img src={`https://openweathermap.org/img/w/${this.props.seattle.icon}.png`} alt={this.props.seattle.condition}/>
                    ...
                    <Link to='/houston'>
                        <div className='city-cat houston-cat'>
                            ...
                            <div className='condition-container'>
                                <img src={`https://openweathermap.org/img/w/${this.props.houston.icon}.png`} alt={this.props.houston.condition}/>
                    ...
                    <Link to='/chicago'>
                        <div className='city-cat chicago-cat'>
                            ...
                            <div className='condition-container'>   
                                <img src={`https://openweathermap.org/img/w/${this.props.chicago.icon}.png`} alt={this.props.chicago.condition}/>
                    ...
                    <Link to='/newyork'>
                        <div className='city-cat newyork-cat'>
                            ...
                            <div className='condition-container'>
                                <img src={`https://openweathermap.org/img/w/${this.props.newYork.icon}.png`} alt={this.props.newYork.condition}/>
